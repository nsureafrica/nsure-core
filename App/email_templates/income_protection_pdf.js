...
function generateCustomerInformation(doc, invoice) {
  doc
    .fillColor("#444444")
    .fontSize(20)
    .text("Income Protection Quote", 50, 160);
...
function generateInvoiceTable(doc, invoice) {
  ...
  generateTableRow(
    ...
    invoiceTableTop + 30,
    "Funeral Cover Limit",
    formatCurrency(invoice.planDetails.funeralCoverLimit)
  );
  generateTableRow(
    doc,
    invoiceTableTop + 60,
    "Retrenchment Cover Limit",
    formatCurrency(invoice.planDetails.retrenchmentCoverLimit)
  );
  generateTableRow(
    doc,
    invoiceTableTop + 90,
