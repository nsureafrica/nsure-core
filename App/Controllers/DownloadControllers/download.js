...
module.exports = {
    downloadTravelDocuments: async (req,res)=>{
         const travelPolicyDocuments = await TravelPolicyModel.findOne({where: {id:req.query.travelPolicyId}})
    ...
    downloadMotorDocuments: async (req,res)=> {
        const MotorPolicyModelResponse = await MotorPolicyModel.findOne({where: {id:req.query.motorPolicyId}}) 
    ...
    downloadClaimDocuments: async (req,res)=> {
        const ClaimModelResponse = await ClaimModel.findOne({where: {id:req.query.claimId}})
